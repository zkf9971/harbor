...
DOCKERIMAGENAME_UI=registry.cloudapp-enterprise-preprod.appctest.com:5000/ypjin/harbor_ui
...
compile_ui:
	...
	@env GOOS=linux GOARCH=amd64 $(GOBUILD) -o $(UIBINARYPATH)/$(UIBINARYNAME) $(UISOURCECODE)
	@echo "Done."
