...
func initRouters() {
	...
	beego.Router("/api/jobs/replication/:id", &api.RepJobAPI{})
	beego.Router("/api/jobs/replication/:id/log", &api.RepJobAPI{}, "get:GetLog")
	beego.Router("/api/policies/replication/:id", &api.RepPolicyAPI{})
	...
	beego.Router("/api/policies/replication/:id/enablement", &api.RepPolicyAPI{}, "put:UpdateEnablement")
	...
	beego.Router("/api/targets/:id/policies/", &api.TargetAPI{}, "get:ListPolicies")
