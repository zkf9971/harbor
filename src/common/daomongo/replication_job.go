...
// GetRepTarget ...
func GetRepTarget(id bson.ObjectId) (*models.RepTarget, error) {
	// o := GetOrmer()
...
// DeleteRepTarget ...
func DeleteRepTarget(id bson.ObjectId) error {
	// o := GetOrmer()
...
// AddRepPolicy ...
func AddRepPolicy(policy models.RepPolicy) (bson.ObjectId, error) {
	// o := GetOrmer()
	...
	// return bson.ObjectId(id), err
	return "", nil
}

// GetRepPolicy ...
func GetRepPolicy(id bson.ObjectId) (*models.RepPolicy, error) {
	// o := GetOrmer()
...
func FilterRepPolicies(name string, projectID bson.ObjectId) ([]*models.RepPolicy, error) {
	// o := GetOrmer()
...
func GetRepPolicyByProject(projectID bson.ObjectId) ([]*models.RepPolicy, error) {
	// o := GetOrmer()
...
func GetRepPolicyByTarget(targetID bson.ObjectId) ([]*models.RepPolicy, error) {
	// o := GetOrmer()
...
func GetRepPolicyByProjectAndTarget(projectID, targetID bson.ObjectId) ([]*models.RepPolicy, error) {
	// o := GetOrmer()
...
// DeleteRepPolicy ...
func DeleteRepPolicy(id bson.ObjectId) error {
	// o := GetOrmer()
...
func UpdateRepPolicyEnablement(id bson.ObjectId, enabled int) error {
	// o := GetOrmer()
	// p := models.RepPolicy{
	// 	ID:         id,
	// 	Enabled:    enabled,
...
// EnableRepPolicy ...
func EnableRepPolicy(id bson.ObjectId) error {
	// return UpdateRepPolicyEnablement(id, 1)
	return nil
}

// DisableRepPolicy ...
func DisableRepPolicy(id bson.ObjectId) error {
	// return UpdateRepPolicyEnablement(id, 0)
	return nil
}

// AddRepJob ...
func AddRepJob(job models.RepJob) (bson.ObjectId, error) {
	// o := GetOrmer()
	// if len(job.Status) == 0 {
...
// GetRepJob ...
func GetRepJob(id bson.ObjectId) (*models.RepJob, error) {
	// o := GetOrmer()
...
// GetRepJobByPolicy ...
func GetRepJobByPolicy(policyID bson.ObjectId) ([]*models.RepJob, error) {
...
// FilterRepJobs ...
func FilterRepJobs(policyID bson.ObjectId, repository, status string, startTime,
...
func GetRepJobToStop(policyID bson.ObjectId) ([]*models.RepJob, error) {
	// var res []*models.RepJob
...
// func repJobPolicyIDQs(policyID bson.ObjectId) orm.QuerySeter {
// 	return repJobQs().Filter("policy_id", policyID)
// }

// DeleteRepJob ...
func DeleteRepJob(id bson.ObjectId) error {
	// o := GetOrmer()
...
// UpdateRepJobStatus ...
func UpdateRepJobStatus(id bson.ObjectId, status string) error {
	// o := GetOrmer()
	// j := models.RepJob{
	// 	ID:         id,
	// 	Status:     status,
